...
// For example a long takes up 1 "C" stack entry but 2 Java stack entries.
  ...
  // Some platforms handle bool/char/byte/short differently from integers
  void do_bool  ()                     { pass_bool();   _jni_offset++; _offset++;       }
  void do_char  ()                     { pass_char();   _jni_offset++; _offset++;       }
...
//  int     java_offset() const          { return method()->size_of_parameters() - _offset - 1; }
  ...
  virtual void pass_bool() { pass_int(); } // default valid for most platforms
  virtual void pass_char()  { pass_int(); }
